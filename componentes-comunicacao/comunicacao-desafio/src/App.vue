<template>
	<div id="app">
		<usuario-lista :usuarios="[...usuarios]" /> <!-- Cuidado ao alterar informações nos componentes filhos, pois elas podem refletir no componente pai devido a referencia de memoria ou valor -->
		<usuario-detalhe />
	</div>
</template>
